...
<style lang="scss">
  ...
  :global(.noUi-handle) {
    ...
    box-shadow: inset 0 0 1px $c-brand-primary, inset 0 1px 7px rgba($c-brand-primary, .7), 0 3px 6px -3px rgba($c-brand-primary, .5);
    cursor: grab;
  ...
  :global(.noUi-connect) {
    background: rgba($c-brand-primary, .5);
  ...
  :global(.noUi-active .noUi-tooltip) {
    ...
    thead {
      tr {
        ...
        th {
          border-bottom: 2px solid rgba($c-brand-primary, .35);
          cursor: pointer;
        }
      }
    }
    ...
    tbody {
        tr {
          ...
          &:nth-child(odd) {
            background-color: rgba($c-brand-primary, .05);
          }
          ...
          td {
            border-bottom: 1px solid rgba($c-brand-primary, .15);
            margin: 0;
            padding: 10px 5px;
          }
        }
...
{#if showSlider}
    <div class="slider">
        ...
        <div class="slider__holder" bind:this={sliderElement}></div>
