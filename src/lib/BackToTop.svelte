...
<div class="back-to-top" on:click={goTop} on:keypress={goTop}>
  <div class="back-to-top__svg-container">
    <svg
      class="large"
      style="transform: rotate({$scrollPositionY / 20}deg);"
    ...
    <svg
      class="small"
      style="transform: rotate({-($scrollPositionY / 10)}deg);"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 50 50"
      height="50px"
      width="50px"
  ...
  .back-to-top {
    ...
    &__svg-container {
      ...
      svg {
        ...
        &.large {
          fill: hsl(var(--c-white) / 0.25);

          :global([data-theme='light']) & {
            fill: hsl(var(--c-black) / 0.25);
          }
        }

        &.small {
          fill: hsl(var(--c-brand-primary) / 0.5);
        }
      }
    }
  }
