...
<div class="back-to-top" on:click={goTop}>
    <div class="back-to-top__svg-container">
        <svg style="transform: rotate({$scrollPositionY / 20}deg); opacity: .25;" height="80px" width="80px" version="1.1"
        ...
        <svg style="transform: rotate(-{$scrollPositionY / 10}deg); opacity: .5;" xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 50 50" height="50px" width="50px" fill="fuchsia">
